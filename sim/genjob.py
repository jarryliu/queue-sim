...
class GenJob(object):
    ...
    def getInterval(self):
        return self.getMarkovInterval(self.intDistr[0], self.intDistr[1])

    def getMarkovInterval(self, distrName, parameters):
        if distrName.startswith("bst"):
            interval = getRandomDist(distrName[3:6], parameters[:-1])
            return interval
