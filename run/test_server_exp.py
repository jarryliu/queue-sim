    ...
    for bRate in bRateList:
        ...
        for distrNameA in distrNameAList:
            for b in bucketSizeList:
                ...
                fileName = dirName + "/" + distrNameA + "_" + str(int(pRate)) + "_" + str(int(bRate)) + "_" + str(int(b)) + "_" +distrNameB + "_" + str(int(mu))+ ".out"
                ...
                cmd = ["python", appDir+t+".py",  str(duration),  str(pRate),
                    str(bRate), str(int(b)), str(mu), distrNameA, distrNameB, fileName]
